...
export const GameModes: {[key: string]: GameModeModel} = {
  ...
  REPLICATION: {
    ...
    assetPath:
      '/Game/GameModes/OneForAll/OneForAll_GameMode.OneForAll_GameMode_C',
    queueId: 'oneforallsr',
  },
  SPIKE_RUSH: {
    ...
    assetPath:
      '/Game/GameModes/QuickBomb/QuickBombGameMode.QuickBombGameMode_C',
    queueId: 'spikerush',
  },
  PRACTICE: {
    ...
    assetPath:
      '/Game/GameModes/ShootingRange/ShootingRangeGameMode.ShootingRangeGameMode_C',
    queueId: 'range',
  },
  SNOWBALL_FIGHT: {
